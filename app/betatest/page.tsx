...
export async function generateMetadata({ params, searchParams }) {
  ...
  return {
    metadataBase: new URL('https://novaenergy.ai/betatest'),
    title,
    description,
    url,
    openGraph: {
...
export default async function ProfileCreation(props) {
  return (
    <Page title={title} description={description} url="https://novaenergy.ai/app">
      <iframe
        className="airtable-embed"
        src="https://airtable.com/embed/appQj9gQfWgXwn7nL/pagyoe23ECUhQ2ysV/form"
        frameBorder="0"
        width="100%"
        height="800px"
