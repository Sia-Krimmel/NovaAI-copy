...
import { FormHeading, FormParagraph } from '@components/typography/forms';
  ...
  return (
    <Page>
      <div className={styles.twoColumns}>
        <img src="/media/grass.png" className={styles.image} />
        ...
        <div className={styles.columnTwo}>
                ...
                <div className={styles.singInContainer}>
                  {props?.viewer ? (
                    ...
                    <>
                      ...
                      <Label style={{ paddingBottom: '0.5rem' }}>E-Mail</Label>
                      <Input
                      ...
                      <Label style={{ paddingBottom: '0.5rem' }}>Password</Label>
                      <Input
          ...
          {props?.signUp ? (
            <Link href="provider" className={styles.signup} style={{ paddingTop: '2rem' }}>
              <P className={styles.signup}>
                Have an account? <span style={{ borderBottom: '1px solid black' }}>Log In</span>
              </P>
            </Link>
          ) : (
            <Link href="provider-signup" className={styles.signup} style={{ paddingTop: '2rem' }}>
              <P className={styles.signup}>
